const projects = [
  {
    ...
    description:
      "Colorful fashion e-commerce website featuring product browsing, collections, sale listings, wishlist management, shopping cart, checkout flow, journal content, and responsive layouts.",
    techStack: [
      "React",
      "Vite",
      "JavaScript",
    ...
    liveUrl: "https://mira-studio-gold.vercel.app/",
    githubUrl: "https://github.com/Obehi123-beep/mira-studio",
    featured: true,
  },
  {
    id: 2,
